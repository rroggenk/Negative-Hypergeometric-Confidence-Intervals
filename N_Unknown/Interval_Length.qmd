...
CI <- minimal_cardinality_ci_N_unkown(M = M, m = m, conf_level = conf_level, 
...
mst_ac_N_unknown(M = M, m = m, conf_level = conf_level, max_N = max_N) %>%
  filter(N <= 200) %>%
...
mst_ac_N_unknown_vec(M = M, m = m, conf_level = conf_level, max_N = max_N) %>%
  filter(N <= 200) %>%
  summarize(avg_coverage = mean(coverage_prob, na.rm = TRUE))
...
cg_ac_N_unknown(M = M, m = m, conf_level = conf_level, max_N = max_N) %>%
  filter(N <= 200) %>%
  summarize(avg_coverage = mean(coverage_prob, na.rm = TRUE))
...
cg_ac_N_unknown_vec(M = M, m = m, conf_level = conf_level, max_N = max_N) %>%
  filter(N <= 200) %>%
  summarize(avg_coverage = mean(coverage_prob, na.rm = TRUE))
...
bk_ac_N_unknown(M = M, m = m, conf_level = conf_level, max_N = max_N) %>%
  filter(N <= 200) %>%
  summarize(avg_coverage = mean(coverage_prob, na.rm = TRUE))
...
bk_ac_N_unknown_vec(M = M, m = m, conf_level = conf_level, max_N = max_N) %>%
  filter(N <= 200) %>%
  summarize(avg_coverage = mean(coverage_prob, na.rm = TRUE))
...
all_ac_N_unknown_vec(M = 25, m = 15, conf_level = 0.95, max_N = 205)
...
mst_ac_N_unknown(M = 50, m = 5, conf_level = 0.95, max_N = 1500)
...
mst_ac_N_unknown(M = 50, m = 15, conf_level = 0.95, max_N = 220)
...
cg_ac_N_unknown(M = 25, m = 5, conf_level = 0.95, max_N = 600)
...
cg_ac_N_unknown(M = 25, m = 15, conf_level = 0.95, max_N = 300)
...
cg_ac_N_unknown(M = 50, m = 5, conf_level = 0.95, max_N = 1500)
...
cg_ac_N_unknown(M = 50, m = 15, conf_level = 0.95, max_N = 300)
...
bk_ac_N_unknown(M = 25, m = 5, conf_level = 0.95, max_N = 600)
...
bk_ac_N_unknown(M = 25, m = 15, conf_level = 0.95, max_N = 300)
...
bk_ac_N_unknown(M = 50, m = 5, conf_level = 0.95, max_N = 1500)
...
bk_ac_N_unknown(M = 50, m = 15, conf_level = 0.95, max_N = 300)
