...
# test_20
# 
# test_20_vec = all_mc_ac_vec(N = 20, m = 3, conf_level = 0.95)
# test_20_vec
```
...
# test_50
# 
# test_50_vec = all_mc_ac_vec(N = 50, m = 3, conf_level = 0.95)
# test_50_vec
```
...
# test_20_MST
# 
# test_20_MST_vec = mst_ac_vec(N = 20, m = 3, conf_level = 0.95)
# test_20_MST_vec
```
...
# test_50_MST
# 
# test_50_MST_vec = mst_ac_vec(N = 50, m = 3, conf_level = 0.95)
# test_50_MST_vec
```
...
# test_20_CG
# 
# test_20_CG_vec = cg_ac_vec(N = 20, m = 3, conf_level = 0.95)
# test_20_CG_vec
```
...
# test_50_CG
# 
# test_50_CG_vec = cg_ac_vec(N = 50, m = 3, conf_level = 0.95)
# test_50_CG_vec
```
...
# test_20_BK
# 
# test_20_BK_vec = bk_ac_vec(N = 20, m = 3, conf_level = 0.95)
# test_20_BK_vec
```
...
# test_50_BK
# 
# test_50_BK_vec = bk_ac_vec(N = 50, m = 3, conf_level = 0.95)
# test_50_BK_vec
```
...
test_20_CI_mst_vec = minimal_cardinality_ci_vec(N = 20, m = 3, conf_level = 0.95, 
                                                procedure = "MST")
test_20_CI_mst_vec
```
...
test_50_CI_mst_vec = minimal_cardinality_ci_vec(N = 50, m = 3, conf_level = 0.95, 
                                                procedure = "MST")
test_50_CI_mst_vec
```
...
test_20_CI_cg_vec = minimal_cardinality_ci(N = 20, m = 3, conf_level = 0.95, 
                                       procedure = "CG")
test_20_CI_cg_vec
```
...
test_50_CI_cg_vec = minimal_cardinality_ci(N = 50, m = 3, conf_level = 0.95, 
                                       procedure = "CG")
test_50_CI_cg_vec
```
...
test_20_CI_bk_vec = minimal_cardinality_ci(N = 20, m = 3, conf_level = 0.95, 
                                       procedure = "BK")
test_20_CI_bk_vec
```
...
test_50_CI_bk_vec = minimal_cardinality_ci(N = 50, m = 3, conf_level = 0.95, 
                                       procedure = "BK")
test_50_CI_bk_vec
```

## Plot of All Minimal Cardinality Curves

```{r}
all_ac_mc_N_50_m_3 = all_mc_ac(N = 50, m = 3, conf_level = 0.95)
all_ac_mc_N_50_m_3
```
...
ggplot(all_ac_mc_N_50_m_3, aes(x = M, 
                               y = coverage_prob, 
                               group = x_set, 
                               color = x_set)) +
  geom_line() +
...
```{r}
plot_all_mc_ac <- function(N, m, conf_level = 0.95) {
  # Initializing the data frame that the function will output 
  results = data.frame(M = integer(), 
                       a = integer(), 
                       b = integer(), 
...
plot = plot_all_mc_ac(N = 50, m = 3, conf_level = 0.95)
conf_level= 0.95
...
filtered_plot <- plot %>%
  filter(x_set %in% all_ac_mc_N_50_m_3$x_set)

conf_level= 0.95

ggplot() +
  geom_line(data = filtered_plot, aes(x = M, 
                                       y = coverage_prob, 
                                       group = x_set, 
                                       color = x_set)) +
  geom_point(data = all_ac_mc_N_50_m_3, aes(x = M, 
                                            y = coverage_prob, 
                                            group = x_set, 
                                            color = x_set)) +
  labs(x = "M", y = "Coverage Probability") +
...
# Loop through each row in all_ac_mc_N_50_m_3
for (i in 1:nrow(all_ac_mc_N_50_m_3)) {
  # Get the current M and x_set
  current_M <- all_ac_mc_N_50_m_3$M[i]
  current_x_set <- all_ac_mc_N_50_m_3$x_set[i]
  
  # Filter for M, M-1, and M+1 where the x_set matches
  filtered_rows <- plot %>%
    filter(M %in% c(current_M, current_M - 1, current_M + 1) & x_set == current_x_set)
...
ggplot() +
  geom_line(data = filtered_plot2, aes(x = M, 
                                       y = coverage_prob, 
                                       group = x_set, 
                                       color = x_set)) +
  geom_point(data = all_ac_mc_N_50_m_3, aes(x = M, 
...
custom_colors <- c(
  ...
  "#fdae61", "#fee08b", "#d73027", "#1a9850", "#4575b4", "#91bfdb", "#762a83", "#af8dc3", 
  "#b2182b", "#4393c3", "#f4a582"
)
...
```{r}
#| label: plot for thesis presentation (1)
...
ggplot() +
  ...
  geom_point(data = all_ac_mc_N_50_m_3, aes(x = M, 
                                            ...
                                            color = x_set)) +
  labs(x = "M", y = "Coverage Probability", 
       title = "Plot of All Minimal Cardinality Acceptancee Curves") +
...
filtered_plot3 <- filtered_plot2 %>%
  filter(!(M == 6 & x_set == "6-39"))

ggplot() +
  geom_line(data = filtered_plot3, aes(x = M, 
                                       y = coverage_prob, 
                                       group = x_set, 
                                       color = x_set)) +
  geom_point(data = all_ac_mc_N_50_m_3, aes(x = M, 
  ...
  labs(x = "M", y = "Coverage Probability") +
  geom_hline(yintercept = conf_level, color = "red") +
  coord_cartesian(xlim = c(5.5, 10.5), ylim = c(conf_level - 0.005, 0.98)) +
  scale_y_continuous(breaks = c(0.95)) +
  scale_color_manual(values = custom_colors) + 
  theme_minimal() +
  theme(
    legend.position = "none", 
  ...
  annotate("text", 
           ...
           label = paste0("2-33"), 
           color = "#542788",
           angle = 0, hjust = 0, vjust = 1, size = 4) +
  annotate("text", 
           x = 5.7, 
           y = 0.9547,
           label = paste0("5-36"), 
...
```{r}
#| label: plot for thesis presentation (2)
...
ggplot() +
  ...
  annotate("text", 
           ...
           y = 0.952,
           label = "2-33", 
           color = "#6a3d9a",  # position 30
           angle = 0, hjust = 0, vjust = 1, size = 4) +
  annotate("text", 
           x = 5.7, 
           y = 0.9547,
           label = "5-36", 
           color = "#762a83",  # originally at position 39 — keep same if still using
           angle = 0, hjust = 0, vjust = 1, size = 4) +
  annotate("text", 
           x = 5.705, 
           y = 0.9578,
           label = "3-34", 
           color = "#fdb462",  # position 33
           angle = 0, hjust = 0, vjust = 1, size = 4) +
  annotate("text", 
           x = 5.71, 
           y = 0.9593,
           label = "4-35", 
           color = "#b3de69",  # position 40
           angle = 0, hjust = 0, vjust = 1, size = 4) +
  # M = 7
  annotate("text", 
           x = 7, 
           y = 0.9525,
           label = "4-32", 
           color = "#d73027",  # position 35
           angle = 0, hjust = 0, vjust = 1, size = 4) +
  annotate("text", 
           x = 6.7, 
           y = 0.9565,
           label = "2-30", 
           color = "#01665e",  # position 31
           angle = 0, hjust = 0, vjust = 1, size = 4) + 
  annotate("text", 
           x = 6.7, 
           y = 0.958,
           label = "3-31", 
           color = "#fdb462",  # position 33 (again)
           angle = 0, hjust = 0, vjust = 1, size = 4) +
  # M = 8
  annotate("text", 
           x = 7.7, 
  ...
  annotate("text", 
           ...
           y = 0.955,
           label = "2-25", 
           color = "#c51b7d",  # position 29
           angle = 0, hjust = 0, vjust = 1, size = 4) +
  annotate("text", 
           x = 8.69, 
           y = 0.9565,
           label = "1-24", 
           color = "#e78ac3",  # position 24
           angle = 0, hjust = 0, vjust = 1, size = 4) +
  # M = 10
  annotate("text", 
           x = 9.9, 
           y = 0.95365,
           label = "2-23", 
           color = "#b3b3b3",  # position 28
           angle = 0, hjust = 0, vjust = 1, size = 4) +
  annotate("text", 
           x = 9.7, 
           y = 0.9576,
           label = "1-22", 
           color = "#66c2a5",  # position 23
           angle = 0, hjust = 0, vjust = 1, size = 4)
