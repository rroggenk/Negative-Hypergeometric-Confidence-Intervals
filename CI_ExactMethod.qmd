...
## Function to Find MST Confidence Intervals Bounds

```{r}
mst_ci <- function(N, m, conf_level = 0.95) {
...
```{r}
#test_20_CI = mst_ci(N = 20, m = 3, conf_level = 0.95)
#test_20_CI
```

```{r}
#test_50_CI = mst_ci(N = 50, m = 3, conf_level = 0.95)
#test_50_CI
```
