...
## Function to Find KB Acceptance Curves

```{r}
kb_ac <- function(N, m, conf_level = 0.95) {
  # Gets all minimal cardinality acceptance curves
  results = all_mc_ac(N, m, conf_level)
...
```{r}
# test_20_KB = kb_ac(N = 20, m = 3, conf_level = 0.95)
# test_20_KB
```

```{r}
# test_50_KB = kb_ac(N = 50, m = 3, conf_level = 0.95)
# test_50_KB
```
...
minimal_cardinality_ci <- function(N, m, conf_level = 0.95, procedure = "MST") {
  ...
  else if (procedure == "KB") {
    results = kb_ac(N, m, conf_level)
  } 
  else {
    stop("Invalid procedure. Choose from 'MST', 'CG', or 'KB'.")
  }
...
```{r}
# test_20_CI_kb = minimal_cardinality_ci(N = 20, m = 3, conf_level = 0.95, procedure = "KB")
# test_20_CI_kb
```

```{r}
# test_50_CI_kb = minimal_cardinality_ci(N = 50, m = 3, conf_level = 0.95, procedure = "KB")
# test_50_CI_kb
```
